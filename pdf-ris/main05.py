...
# INPUT PDF
# ----------------------------
pdf_path = Path(r"E:\XRZONE_Files\PDFReader\PDFReader\pdf-ris\samples\v4\Jitta Collectie Wat ons blijvend boeit.pdf")
...
for i, match in enumerate(matches):
    ...
    # Block text: from end of this code to start of next code (or end of text)
    start_idx = match.end()
